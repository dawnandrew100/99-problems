...
void* get_penultimate_element(ArrayType type, void* input_array, int arr_length);
void print_penultimate_element(ArrayType type, void* input_array, int arr_length);
...
int main() {
    ...
    print_penultimate_element(INT_ARRAY, my_int_array, array_length);

    // Example for SHORT_ARRAY
    short my_short_array[] = {10, 20, 30, 40, 50};
    array_length = sizeof(my_short_array) / sizeof(my_short_array[0]);
    print_penultimate_element(SHORT_ARRAY, my_short_array, array_length);
    ...
    print_penultimate_element(LONG_ARRAY, my_long_array, array_length);
    ...
    print_penultimate_element(LONG_LONG_ARRAY, my_long_long_array, array_length);

    // Example for CHAR_ARRAY
    char my_char_array[] = {'a', 'C', 'a', 'B', 'B', 'L', 'm'};
    array_length = sizeof(my_char_array) / sizeof(my_char_array[0]);
    print_penultimate_element(CHAR_ARRAY, my_char_array, array_length);
    ...
    print_penultimate_element(FLOAT_ARRAY, my_float_array, array_length);
    ...
    print_penultimate_element(DOUBLE_ARRAY, my_double_array, array_length);
    ...
    print_penultimate_element(LONG_DOUBLE_ARRAY, my_long_double_array, array_length);
...
void print_penultimate_element(ArrayType type, void* input_array, int arr_length){
    switch(type){
        case INT_ARRAY:
            ;
            int* res_int = (int*)get_penultimate_element(type, input_array, arr_length);
            printf("%d\n", *res_int);
            break;
        case SHORT_ARRAY:
            ;
            short* res_short = (short*)get_penultimate_element(type, input_array, arr_length);
            printf("%d\n", *res_short);
            break;
        case LONG_ARRAY:
            ;
            long* res_long = (long*)get_penultimate_element(type, input_array, arr_length);
            printf("%ld\n", *res_long);
            break;
        case LONG_LONG_ARRAY:
            ;
            long long* res_long_long = (long long*)get_penultimate_element(type, input_array, arr_length);
            printf("%lld\n", *res_long_long);
            break;
        case CHAR_ARRAY:
            ;
            char* res_char = (char*)get_penultimate_element(type, input_array, arr_length);
            printf("%c\n", *res_char);
            break; 
        case FLOAT_ARRAY:
            ;
            float* res_float = (float*)get_penultimate_element(type, input_array, arr_length);
            printf("%f\n", *res_float);
            break;
        case DOUBLE_ARRAY:
            ;
            double* res_double = (double*)get_penultimate_element(type, input_array, arr_length);
            printf("%.5g\n", *res_double);
            break;
        case LONG_DOUBLE_ARRAY:
            ;
            long double* res_long_double = (long double*)get_penultimate_element(type, input_array, arr_length);
            printf("%.5Lg\n", *res_long_double);
            break;
        default:
